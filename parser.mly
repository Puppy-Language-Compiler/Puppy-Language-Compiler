...
ty:
  ...
  | ARRAY OF ID { Absyn.ArrayTy(Symbol.symbol $3, mk_pos 1) }
;
tyfields:
  |         { [] }
  | tyfield { $1 :: [] }
...
lvalue:
  ...
  | ID DOT ID { Absyn.RecordAccess{record = Absyn.Ident{name = Symbol.symbol $1; pos = mk_pos 1}; name = Symbol.symbol $3; pos = mk_pos 1} }
  | lvalue DOT ID { Absyn.RecordAccess{record = $1; name = Symbol.symbol $3; pos = mk_pos 1} }
  | ID LBRACKET exp RBRACKET { Absyn.ArrayAccess{array = Absyn.Ident{name = Symbol.symbol $1; pos = mk_pos 1}; exp = $3; pos = mk_pos 1} }
